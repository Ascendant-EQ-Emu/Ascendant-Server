...
sub EVENT_KILLED_MERIT {
	...
	quest::set_data("classic_vox_" . $account_id, $char_name);
	#$client->Message(15, "You have defeated Lady Vox! Seek out Aurelian Stoneward in the Guild Lobby to claim your Classic completion.");
}
