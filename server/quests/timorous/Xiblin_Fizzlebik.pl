...
sub EVENT_ITEM {
  if (quest::handin({ 19959 => 1, 19960 => 1, 19961 => 1 })) {
    ...
    quest::summonitem(19954); # Medallion of the Jarsath
    quest::exp(100);
  }
  else {
    quest::say("I need all three pieces together. Bring me the Fragment of Jarsath, the Shard of Jarsath, and the Sliver of Jarsath at the same time.");
    # No need for return_items with the new system; unmatched items are returned automatically.
  }
}
