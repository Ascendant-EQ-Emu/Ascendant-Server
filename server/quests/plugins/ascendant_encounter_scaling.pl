...
my %PROFILE_TUNING = (
    raid => {
        hp_solo_floor    => 0.33,
        hp_solo_ceiling  => 0.64,
        hp_group_base    => 0.68,
        hp_group_cap     => 0.88,
        melee_solo_floor => 0.33,
        melee_solo_ceil  => 0.61,
        melee_group_base => 0.61,
        ...
        resist_solo_min  => -119,
        resist_solo_max  => -38,
        resist_group_base => -27,
        resist_group_cap => -5,
    },
    named => {
        hp_solo_floor    => 0.39,
        hp_solo_ceiling  => 0.66,
        hp_group_base    => 0.72,
        hp_group_cap     => 0.88,
        melee_solo_floor => 0.39,
        melee_solo_ceil  => 0.66,
        melee_group_base => 0.66,
        melee_group_cap  => 0.79,
        atk_solo_floor   => 0.50,
        atk_group_base   => 0.66,
        atk_group_cap    => 0.83,
        resist_solo_min  => -97,
        resist_solo_max  => -20,
        resist_group_base => -16,
        resist_group_cap => -4,
    },
    trash => {
        hp_solo_floor    => 0.55,
        hp_solo_ceiling  => 0.83,
        hp_group_base    => 0.86,
        hp_group_cap     => 0.99,
        melee_solo_floor => 0.55,
        melee_solo_ceil  => 0.83,
        melee_group_base => 0.83,
        melee_group_cap  => 0.94,
        atk_solo_floor   => 0.61,
        atk_group_base   => 0.83,
        atk_group_cap    => 0.94,
        resist_solo_min  => -59,
