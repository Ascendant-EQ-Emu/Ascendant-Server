# items: 48060, 12844, 12845, 12633, 48045, 48046, 48051, 48047, 48061, 48048, 48064, 48065, 48066, 48067, 48049, 48075, 48050
sub EVENT_SAY {
  if ($text=~/hail/i) {
...
sub EVENT_ITEM {
  ...
  elsif (plugin::check_handin(\%itemcount, 48075 => 1, 48049 => 1)) { #Sacred Figurine + Claw of the Mature Patriarch
    quest::say("You have honored your fellow Patriarchs, $name. Join us now in celebration as you gain the rank, Elder Spiritualist!");
    quest::summonitem(48050); #Claw of the Spiritual Elder
    quest::exp(50000);
    quest::ding();
    quest::faction(445,30); # Faction: Scaled Mystics
    quest::faction(441,15); # Faction: Legion of Cabilis
  }
