# Harley Wynn - Gambling NPC (Guild Lobby)
# Author: Straps
#
# Players buy Lucky Coins for platinum or via the Transmute Experience AA,
# then hand them in for a random tiered prize. Actual roll logic lives in
# ascendant_gambling.pl plugin; this script handles the buy/handin flow
# and tier-specific messaging. Max 10 coins per trade to limit spam.
